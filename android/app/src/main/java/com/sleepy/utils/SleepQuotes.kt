...
object SleepQuotes {
    ...
    private val supportiveQuotes = quotes.subList(0, 50)
    private val urgentQuotes = quotes.subList(50, 100)

    fun getRandomQuote(): String {
        return quotes[Random.nextInt(quotes.size)]
    }

    fun getSupportiveQuote(): String {
        return supportiveQuotes[Random.nextInt(supportiveQuotes.size)]
    }

    fun getUrgentQuote(): String {
        return urgentQuotes[Random.nextInt(urgentQuotes.size)]
    }
}
